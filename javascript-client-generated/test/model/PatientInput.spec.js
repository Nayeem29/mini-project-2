...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PatientInput', function() {
      beforeEach(function() {
        instance = new DentistAppointmentApi.PatientInput();
      });

      it('should create an instance of PatientInput', function() {
        // TODO: update the code to test PatientInput
        expect(instance).to.be.a(DentistAppointmentApi.PatientInput);
      });
